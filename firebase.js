...
export const CHARACTER_DATA = {
  ...
  "媱":{ char:"媱", pinyin:"yáo", category:"reclaim", pollutionLevel:1,
    shuowen:"曲美貌。从女，䍃声。",
    modern:"",
  ...
  // 新增字（分析暂缺，释义见 dict-defs.js）
  "威":{ char:"威", pinyin:"wēi", category:"institution", pollutionLevel:3,
    shuowen:"姑也。从女从戌。",
    modern:"",
    analysis:"" },
  "妿":{ char:"妿", pinyin:"ē", category:"institution", pollutionLevel:3,
    shuowen:"女師也。",
    modern:"",
    analysis:"" },
  "媢":{ char:"媢", pinyin:"mào", category:"stigma", pollutionLevel:4,
    shuowen:"夫妒婦也。从女冒聲。一曰相視也。",
    modern:"",
    analysis:"" },
  "嫚":{ char:"嫚", pinyin:"màn", category:"stigma", pollutionLevel:3,
    shuowen:"侮易也。从女曼聲。",
    modern:"",
    analysis:"" },
  "姦":{ char:"姦", pinyin:"jiān", category:"stigma", pollutionLevel:5,
    shuowen:"私也。从三女。一曰詐也，淫也。",
    modern:"",
    analysis:"" },
  "嬾":{ char:"嬾", pinyin:"lǎn", category:"stigma", pollutionLevel:3,
    shuowen:"懈也，怠也，一曰卧也。从女，賴聲。",
    modern:"",
    analysis:"" },
  "㜥":{ char:"㜥", pinyin:"mái", category:"stigma", pollutionLevel:4,
    shuowen:"",
    modern:"",
    analysis:"" },
  "娭":{ char:"娭", pinyin:"xī", category:"stigma", pollutionLevel:3,
    shuowen:"",
    modern:"",
    analysis:"" },
  "娔":{ char:"娔", pinyin:"kè", category:"stigma", pollutionLevel:3,
    shuowen:"",
    modern:"",
    analysis:"" },
  "㜯":{ char:"㜯", pinyin:"xī", category:"stigma", pollutionLevel:3,
    shuowen:"悅樂也。",
    modern:"",
    analysis:"" }
};
